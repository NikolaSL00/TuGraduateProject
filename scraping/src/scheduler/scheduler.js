...
export const scheduler = () => {
  const jobs = [
    ...
    {
      name: "minamart",
      cron: "0 1,13 * * *", // starts at 1 AM and 1 PM
      worker: `minamart.js`,
    },
    {
      name: "gastronom",
      cron: "0 2,14 * * *", // starts at 2 AM and 2 PM
      worker: `gastronom.js`,
    },
    {
      name: "shopGladen",
      cron: "0 3,15 * * *", // starts at 3 AM and 3 PM
      worker: `shopGladen.js`,
    },
    {
      name: "ebag",
      cron: "0 4,16 * * *", // starts at 4 AM and 4 PM
      worker: `ebag.js`,
    },
    {
      name: "parkmartSofia",
      cron: "0 5,17 * * *", // starts at 5 AM and 5 PM
      worker: `parkmartSofia.js`,
    },
    {
      name: "parkmartVarna",
      cron: "0 6,18 * * *", // starts at 6 AM and 6 PM
      worker: `parkmartVarna.js`,
    },
    {
      name: "parkmartBurgas",
      cron: "0 7,19 * * *", // starts at 7 AM and 7 PM
